...
//   const stats = [
//     { label: 'Courses Enrolled', value: 3, icon: BookOpen, color: 'bg-primary-100 text-primary-600' },
//     { label: 'Certificates Earned', value: 2, icon: Award, color: 'bg-green-100 text-green-600' },
//     { label: 'Job Applications', value: 5, icon: Briefcase, color: 'bg-blue-100 text-blue-600' },
//     { label: 'Learning Hours', value: 48, icon: Clock, color: 'bg-orange-100 text-orange-600' },
//   ]

//   const recentCourses = [
//     { id: 1, title: 'Blockchain Fundamentals', progress: 75, lastAccessed: '2 days ago' },
//     { id: 2, title: 'Smart Contract Development', progress: 40, lastAccessed: '5 days ago' },
//     { id: 3, title: 'Crypto Trading Mastery', progress: 20, lastAccessed: '1 week ago' },
//   ]
